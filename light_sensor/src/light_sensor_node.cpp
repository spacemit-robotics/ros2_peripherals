...
public:
    ...
    : rclcpp::Node("light_sensor_node")
    {
        ...
        dev_ = light_sensor_alloc_i2c(
            compose_driver_instance().c_str(), i2c_dev_.c_str(), static_cast<uint8_t>(i2c_addr_));
        if (dev_ == nullptr) {
        ...
        pub_ = create_publisher<sensor_msgs::msg::Illuminance>(
        ...
        RCLCPP_INFO(
            ...
            driver_.c_str(), name_.c_str(), i2c_dev_.c_str(), i2c_addr_, topic_name_.c_str(),
            poll_hz_);
    }
