...
#ifndef _FAST_DDS_GENERATED_MY_BUILTIN_INTERFACES_MSG_TIME_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_MY_BUILTIN_INTERFACES_MSG_TIME_PUBSUBTYPES_H_
...
#endif // _FAST_DDS_GENERATED_MY_BUILTIN_INTERFACES_MSG_TIME_PUBSUBTYPES_H_
